...
<template>
  <div
    ...
    class="bg-space-black/20 absolute bottom-4 left-4 max-w-64 rounded-lg font-sans backdrop-blur-sm sm:bottom-8 sm:left-8 sm:max-w-sm md:bottom-8 md:max-w-md"
  >
